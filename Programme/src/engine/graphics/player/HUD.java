...
/**
 * This is HUD (Head-Up display) of the game where the player can have information about the game.
...
public class HUD implements IDrawable{
	...
	/**
	 * Prepare the HUD when the player is registered.
	 */
	private void init() {
   ...
   public void update(int delta) {
	...
	/**
	 * Register the player in the ATH.
	 * @param player
	 */
   ...
   /*---Singleton part--------------------------------------------------------*/
	...
	/**
	 * This private class allow the singleton to be thread safe.
	 * @author Brito Carvalho Bruno
	 * @author Decorvet Grégoire
	 * @author Ngo Quang Dung
	 * @author Schweizer Thomas
